...
contract MiddleMan {
    function enter(address prey, bytes8 gateKey, uint256 gasLimit) public {
        GatekeeperOne(prey).enter{gas: gasLimit}(gateKey);
    }
}

// gateTwo: brute force cal. gas
...
contract GatekeeperOneTest is Test {
    ...
    function test() public {
        ...
        for (uint256 i = 10000; i < 100000; i++) {
